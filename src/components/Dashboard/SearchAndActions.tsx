...
const SearchAndActions: React.FC = () => { 
  ...
  <div className="grid grid-cols-2 lg:grid-cols-6 items-center justify-between mb-4">
    ...
    <button className="flex items-center space-x-1 bg-blue-500 text-white px-6 py-3 rounded-lg">
      <Plus size={20} />
      <span className="hidden sm:inline">Транзакцию</span>
      <span className="inline sm:hidden">Транз.</span>
    </button>
    <button className="flex items-center space-x-2 bg-blue-500 text-white px-6 py-3 rounded-lg ml-4">
      <Plus size={20} />
